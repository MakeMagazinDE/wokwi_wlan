...
# Google Sheets WEB-App URLs für POST and GET Aufruf:
# Kopiere die WEB-App URLs aus deiner Web-App in die folgenden beiden Zeilen
...
# Interrupt-Konfiguration zum Blinkenlassen der LEDs. Die folgenden 2 Zeilen auskommentieren, wenn
# die LEDs nicht blinken sollen
